const Modal = ({ clickedImage, setClickedImage, handleRotationRight,
    handleRotationLeft }) => { 
 
    const handleClick = (e) => {  //onClick function to close modal
    ...
    return <>
        <div className="overlay dismiss" onClick={handleClick}> 
            <img src={clickedImage} alt="expanded image" />
